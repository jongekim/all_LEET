        ...
        <div className="bg-white rounded-lg shadow p-6 sm:p-8 space-y-6">
          ...
          <article className="space-y-6 text-sm text-gray-700 leading-relaxed">
            <section className="space-y-2">
              ...
              <p>
                all LEET(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.
              </p>
            </section>

            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제2조(개인정보 처리의 원칙)</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제3조(본 방침의 공개)</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제4조(본 방침의 변경)</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제5조(회원 가입을 위한 정보)</h2>
              <p>회사는 이용자의 회사 서비스에 대한 회원가입을 위하여 다음과 같은 정보를 수집합니다.</p>
              <p>필수 수집 정보: 이메일 주소, 비밀번호, 이름 및 생년월일</p>
            </section>

            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제6조(본인 인증을 위한 정보)</h2>
              <p>회사는 이용자의 본인인증을 위하여 다음과 같은 정보를 수집합니다.</p>
              <p>필수 수집 정보: 이메일 주소</p>
            </section>

            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제7조(회사 서비스 제공을 위한 정보)</h2>
              <p>회사는 이용자에게 회사의 서비스를 제공하기 위하여 다음과 같은 정보를 수집합니다.</p>
              <p>필수 수집 정보: 아이디, 이메일 주소, 이름 및 생년월일</p>
              <p>선택 수집 정보: 채점 기록 및 서비스 이용 과정에서 필요한 정보</p>
            </section>

            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제8조(서비스 이용 및 부정 이용 확인을 위한 정보)</h2>
              <p>
              ...
              <p>필수 수집 정보: 서비스 이용기록, 쿠키 및 접속지 정보</p>
            </section>

            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제9조(기타 수집 정보)</h2>
              <p>회사는 아래와 같이 정보를 수집합니다.</p>
              <p>수집목적: 부적절한 서비스 이용 방지</p>
              <p>수집정보: 채팅 내용, 일시, 닉네임 등 채팅과 관련된 일체의 정보</p>
            </section>

            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제10조(개인정보 수집 방법)</h2>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제11조(개인정보의 이용)</h2>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제12조(사전동의 등에 따른 개인정보의 제공)</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제13조(개인정보의 처리 위탁)</h2>
              <p>회사는 원활한 서비스 제공과 효과적인 업무를 처리하기 위하여 다음 각 호와 같이 개인정보를 처리 위탁하고 있습니다.</p>
              <p>
                Supabase에게 일체의 개인정보 처리 및 보관, DB 운영 및 보관를 위하여 회원 탈퇴 시 혹은 개인정보 삭제 요청 시동안 개인정보처리를 위탁함
              </p>
            </section>

            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제14조(개인정보의 보유 및 이용기간)</h2>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제15조(법령에 따른 개인정보의 보유 및 이용기간)</h2>
              ...
              <p className="pt-2">통신비밀보호법에 따른 보유정보 및 보유기간</p>
              <ul className="list-disc pl-5 space-y-1">
                <li>웹사이트 로그 기록 자료 : 3개월</li>
              </ul>
              <p className="pt-2">전자금융거래법에 따른 보유정보 및 보유기간</p>
              <ul className="list-disc pl-5 space-y-1">
                <li>전자금융거래에 관한 기록 : 5년</li>
              </ul>
              <p className="pt-2">위치정보의 보호 및 이용 등에 관한 법률</p>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제16조(개인정보의 파기원칙)</h2>
              <p>회사는 원칙적으로 이용자의 개인정보 처리 목적의 달성, 보유·이용기간의 경과 등 개인정보가 필요하지 않을 경우에는 해당 정보를 지체 없이 파기합니다.</p>
            </section>

            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제17조(개인정보파기절차)</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제18조(개인정보파기방법)</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제19조(광고성 정보의 전송 조치)</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제20조(아동의 개인정보보호)</h2>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제21조(이용자의 의무)</h2>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제22조(회사의 개인정보 관리)</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제23조(삭제된 정보의 처리)</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제24조(비밀번호의 암호화)</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제25조(해킹 등에 대비한 대책)</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제26조(개인정보 처리 최소화 및 교육)</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제27조(개인정보 유출 등에 대한 조치)</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제28조(개인정보 유출 등에 대한 조치의 예외)</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제29조(국외 이전 개인정보의 보호)</h2>
              <p>회사는 이용자의 개인정보에 관하여 개인정보보호법 등 관계 법규를 위반하는 사항을 내용으로 하는 국제계약을 체결하지 않습니다.</p>
              <p>
              ...
              <p>회사는 본조 제2항 본문에 따른 동의를 받으려면 미리 다음 각 호의 사항 모두를 이용자에게 고지합니다.</p>
              <ul className="list-disc pl-5 space-y-1">
                <li>이전되는 개인정보 항목</li>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제30조(개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제31조(쿠키 설치 허용 지정 방법)</h2>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제32조(회사의 개인정보 보호 책임자 지정)</h2>
              <p>회사는 이용자의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보 보호 책임자를 지정하고 있습니다.</p>
              <div className="space-y-1">
                <p className="font-semibold text-gray-900">개인정보 보호 책임자</p>
                <p>성명: 김종은</p>
                <p>직책: 대표</p>
                <p>전화번호: 010-9619-9334</p>
                <p>
                  이메일:{' '}
                  <a className="text-blue-600 hover:text-blue-700" href="mailto:all_leet@naver.com">
                    all_leet@naver.com
                  </a>
                </p>
              </div>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-gray-900">제33조(권익침해에 대한 구제방법)</h2>
              <p>
